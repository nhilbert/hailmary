const es = {
  ...
  'engine.orion':      'Pulso nuclear (Orion)',
  'engine.fusion':     'Motor de fusión (Daedalus)',
  'engine.antimatter': 'Antimateria (haz de piones)',
  ...
  'preset.orion-battleship':    'Acorazado Orion',
  'preset.fusion-explorer':     'Explorador de fusión',
  'preset.antimatter-torch':    'Antorcha de antimateria',
